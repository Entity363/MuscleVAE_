...
if __name__ == "__main__":
    ...
    parser.add_argument('--config_file', default='./Data/Parameters/muscle1min.yml', help= 'a yaml file contains the training information')
    ...
    """MUSCLE GUY"""
    #obs_sz = env.observation
    #obs_sz_rigid = env.observation_rigid
    #act_sz = env.action_dim
    agent = MuscleVAE(386, 371, 284, 138 ,env, **args)
